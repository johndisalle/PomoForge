...
// Shared types for the Widget extension — duplicated from main app's SharedTypes.swift
// This file should ONLY be added to the PomoForgeWidgetExtension target
